...
#define DRIVER_RUN_FILE	"/usr/local/games/griljor/bin/grildriver"
...
#define DEFAULT_MAP_PATH \
	"/usr/local/games/griljor/lib/map/default.map"
...
#define OBJ_LIB_DIR \
	"/usr/local/games/griljor/lib/obj"
#define MAP_LIB_DIR \
	"/usr/local/games/griljor/lib/map"
#define HELP_LIB_DIR \
	"/usr/local/games/griljor/lib"
...
#define EDITOR_HELP_FILE \
	"/usr/local/games/griljor/lib/editor.help"
#define PLAYER_HELP_FILE \
	"/usr/local/games/griljor/lib/player.help"
#define GAME_HELP_FILE	 \
	"/usr/local/games/griljor/lib/game.help"
#define OBTOR_HELP_FILE  \
	"/usr/local/games/griljor/lib/obtor.help"
#define HOST_HELP_FILE	\
	"/usr/local/games/griljor/lib/host.help"

/* location of current news file for game startup */
#define NEWS_FILE \
	"/usr/local/games/griljor/lib/news"

/* location of the time resitrictions file, if it exists */
#define TIME_FILE \
	"/usr/local/games/griljor/lib/times"
...
#define DFLT_PASS_FILE \
	"/usr/local/games/griljor/lib/players"

/* default game list file that players will search to find games to join */
#define DFLT_GAME_FILE \
	"/usr/local/games/griljor/lib/games"

/* default monster variable file, for specifying monster info */
#define DFLT_VAR_FILE \
	"/usr/local/games/griljor/lib/variables"

/* default bitmap and mask that players will assume when joining game */
#define DFLT_BITMAP \
	"/usr/local/games/griljor/lib/man.bit"
#define DFLT_MASK \
	"/usr/local/games/griljor/lib/man.mask"

/* location of bitmaps used by the editpass program */
#define	SLIDER_FILE_NAME \
	"/usr/local/games/griljor/lib/bit/slider.bit"
#define	ICON_FILE_NAME \
	"/usr/local/games/griljor/lib/bit/icon.bit"
#define DISC_FILE_NAME \
	"/usr/local/games/griljor/lib/bit/disc_icon.bit"
#define GREY_FILE_NAME \
	"/usr/local/games/griljor/lib/bit/grey.bit"
#define PICT_FILE_NAME \
       "/usr/local/games/griljor/lib/bit/pict.bit"
#define TITLE_FILE_NAME \
       "/usr/local/games/griljor/lib/bit/title.bit"
...
#define GM_FILE \
	"/usr/local/games/griljor/lib/messages"
#define	GM_PERSONALITY \
	"/usr/local/games/griljor/lib/gm.text"
