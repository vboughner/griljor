The zip files in this folder are the source for what I made this initial repository out of. I tried to pull together the files for v1.0 (on v1.0 branch) and v2.0 (on master branch).
