h19195
s 00002/00095/01106
d D 1.29 92/09/03 14:53:04 vbo 29 28
c removed calls to whats_on_square and made use of mapfunc.c routines
e
s 00013/00009/01188
d D 1.28 92/08/28 13:34:58 vbo 28 27
c started conversion to new object type
e
s 00000/00000/01197
...
E 28
I 28
long	id;		/* id number of this missile (book-keeping) */
E 28
...
E 28
I 28
  if ((newroom = get_record(exit_char, REC_DETAIL)) == -1) return; 
E 28
E 24
...
E 28
I 28
  move = makelocation(get_record(exit_char, REC_INFOX),
		      get_record(exit_char, REC_INFOY), NULL);
E 28
...
E 29
I 29
    if (!may_fire_onto_square(roomnum, move->x, move->y))
E 29
      return TRUE;
...
E 29
I 29
  dont_let_it_get_away = ! may_fire_through_square(roomnum, m->x, m->y);
E 29
E 10
