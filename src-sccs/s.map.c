h57323
s 00000/00000/00251
d D 1.10 92/08/07 21:13:06 vbo 10 9
c fixes for sun port merged in
e
s 00002/00002/00249
d D 1.9 92/03/11 20:52:53 vanb 9 8
c added to structures for containers, fixed more bugs
e
s 00023/00010/00228
d D 1.8 92/03/02 22:07:09 vanb 8 7
c finished getting editmap to work on basics
e
s 00001/00001/00237
d D 1.7 92/02/21 23:00:59 vanb 7 6
c 
e
s 00005/00002/00233
d D 1.6 92/02/20 21:58:19 vanb 6 5
c 
e
s 00091/00920/00144
d D 1.5 92/02/15 01:07:46 vanb 5 4
c major changes to map structures
e
s 00001/00000/01063
d D 1.4 91/10/16 20:05:46 labc-4lc 4 3
c changed made for DecStations
e
s 00033/00004/01030
d D 1.3 91/08/03 21:01:38 labc-3id 3 2
c added code to check for out-of-bounds object numbers
e
s 00005/00008/01029
d D 1.2 91/06/30 18:38:42 labc-3id 2 1
c took out references to now out-dated object property flags
e
s 01037/00000/00000
d D 1.1 91/02/16 12:54:44 labc-3id 1 0
c date and time created 91/02/16 12:54:44 by labc-3id
e
u
U
f e 0
...
I 5
D 8
  MapInfo *map = lib_load_map(mapfile);
  if (!map) {
    Gerror("unable to read map file");
E 5
  }
...
D 9
  ...
  if (!square) Gerror("bad square in put_down_object");
E 9
I 9
...
D 3
    if (x == ptr->obj.x && y == ptr->obj.y) return ptr;
E 3
I 3
...
I 5
D 6
  OI *obj = first_obj_here(roomnum, x, y);
  if (!obj || info[obj->type]->masked) return(0);
E 6
I 6
  OI *obj;
  SquareRec *square = get_square(&mapstats, roomnum, x, y);
...
E 2
  ...
  for (i=0; i < ROOM_DEPTH + 1; i++)
D 2
    if (info[(uc)whats_here[i]]->move) {
      if (info[(uc)whats_here[i]]->movement < maximum)
	maximum = info[(uc)whats_here[i]]->movement;
    }
    else maximum = 0;
E 2
I 2
...
D 2
    if (!info[(uc)whats_here[i]]->move) move = FALSE;
E 2
I 2
