h51552
s 00000/00054/00631
d D 1.9 92/08/27 20:28:54 vbo 9 8
c remove map related function to mapX11.c
e
s 00003/00002/00682
d D 1.8 92/08/07 21:18:32 vbo 8 7
c fixes for sun port merged in
e
s 00001/00000/00683
d D 1.7 92/03/11 20:52:47 vanb 7 6
c added to structures for containers, fixed more bugs
e
s 00006/00006/00677
d D 1.6 92/02/20 21:57:35 vanb 6 5
c 
e
s 00003/00002/00680
...
E 6
I 6
  pixel_width = text_width(bigfont, s) + WINDOW_BORDERS*2;
  pixel_height = text_height(bigfont) + WINDOW_BORDERS*2;
E 6
  ...
  help_window = make_help_window(roomwin, (ROOM_PIXELS_WIDE - pixel_width)/2,
				 ...
				 strlen(s), 1, bigfont);
I 7
  resize_help_window_pixel_size(help_window, pixel_width, pixel_height);
E 7
