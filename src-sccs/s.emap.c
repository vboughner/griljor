h09595
s 00000/00000/00210
d D 1.4 92/08/07 21:19:06 vbo 4 3
c fixes for sun port merged in
e
s 00010/00008/00200
d D 1.3 92/03/11 20:52:44 vanb 3 2
c added to structures for containers, fixed more bugs
e
s 00020/00013/00188
d D 1.2 92/03/02 22:07:05 vanb 2 1
c finished getting editmap to work on basics
e
s 00201/00000/00000
d D 1.1 92/02/15 01:15:19 vanb 1 0
c date and time created 92/02/15 01:15:19 by vanb
e
u
U
t
...
D 3
  for (i=x1; i<=x2; i++)
    for (j=y1; j<=y2; j++) {
      ...
      square2 = get_square(&mapstats, room2, abs(xfactor-i), abs(yfactor-j));
      if (square1 && square2)
	copy_square_overwrite(&mapstats, square1, square2);
    }
E 3
I 3
  if ((room1 >= 0 && room1 < mapstats.rooms) &&
